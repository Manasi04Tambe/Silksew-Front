...
//           axios.get("https://silksew-back-1.onrender.com/api/products", {
//             headers: { Authorization: `Bearer ${token}` },
//           }),
//           axios.get("https://silksew-back-1.onrender.com/api/orders", {
//             headers: { Authorization: `Bearer ${token}` },
//           }),
//         ])
...
const Dashboard = () => {
  ...
  const pieChartData = [
    ...
    { name: 'Sales (100s)', value: Math.round(totalSales / 100), color: '#DC2626', icon: faDollarSign }
  ]
