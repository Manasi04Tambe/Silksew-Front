...
function ForgotPassword() {
    ...
    const userValid = async () => {
        const res = await fetch(`https://silksew-back.onrender.com/api/forgot-password/forgotpassword/${id}/${token}`, {
            method: "GET",
            headers: {
    ...
    const sendPassword = async (e) => {
        ...
        if (password === "") {
            ...
            const res = await fetch(`https://silksew-back.onrender.com/api/change-password/${id}/${token}`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
