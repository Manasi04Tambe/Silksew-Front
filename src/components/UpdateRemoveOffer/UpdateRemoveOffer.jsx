...
//         try {
//             const response = await axios.get("https://silksew-back-1.onrender.com/api/offer/get-offer");
//             const fetchedOffer = response.data.offer;
...
//         e.preventDefault();
//         try {
//             await axios.put(`https://silksew-back-1.onrender.com/api/offer/update-offer/${editingOffer._id}`, editingOffer);
...
//         try {
//             await axios.delete(`https://silksew-back-1.onrender.com/api/offer/delete-offer/${id}`);
...
function UPdateRemoveoffer() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await axios.put(
        `https://silksew-back-1.onrender.com/api/offer/update-offer/${editingOffer._id}`,
        editingOffer
      );
      toast.success("Offer updated successfully");
      fetchOffers();
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <ToastContainer position="top-center" style={{ marginTop: 70, zIndex: 9999 }} />
